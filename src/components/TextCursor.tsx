...
const TextCursor: React.FC<TextCursorProps> = ({
  ...
  return (
    <div ref={containerRef} className="w-full h-full relative text-[#6f1d1d]">
      <div className="absolute inset-0 pointer-events-none text-[#6f1d1d]">
        <AnimatePresence>
          {trail.map(item => (
            <motion.div
              key={item.id}
              ...
              className="absolute select-none whitespace-nowrap text-3xl text-[#6f1d1d]"
